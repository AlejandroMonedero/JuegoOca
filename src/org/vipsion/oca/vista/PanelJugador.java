...
/**
 *Describe el panel de cada jugador.
...
public class PanelJugador extends JPanel {
    ...
    /**
     *Instancia el panel jugador e inicializa sus componentes.
     * @param id Identificador propio de cada jugador.
     */
    ...
    /**
     *Establece el valor del dado y lo convierte a formato texto.
     * @see JTextField#setText(java.lang.String) 
     * @param valor Valor del dado a convertir.
     */
    ...
    /**
     *Permite determinar al panel la posición en el tablero del jugador y pasarla a formato texto.
     * @see JTextField#setText(java.lang.String) 
     * @param posicion Posición del jugador en el tablero a convertir.
     */
    ...
    /**
     *Deshabilita el botón de tirada del dado de cada panel.
     * @see JButton#setEnabled(boolean) 
     */
    ...
    /**
     *Envía un mensaje de texto al jugador ganador, el cual se ha decidido establecer en color rojo.
     * @see JLabel#setText(java.lang.String) 
     * @see JLabel#setForeground(java.awt.Color) 
     */
    ...
    /**
     *Habilita el botón de tirada del dado de cada panel.
     * @see JButton#setEnabled(boolean) 
     */
